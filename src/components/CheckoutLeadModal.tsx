...
import type { PlanConfig, SupportedCurrency } from '../config/checkoutConfig';
          ...
          {!isSuccess ? (
            ...
            <div className="text-center py-10 space-y-4">
              ...
              <p className="text-sm text-slate-600 max-w-md mx-auto">
                Seu acesso ao <strong>Lab Kids</strong> está confirmado. Entrando no painel dos pais e nas trilhas de ciências...
              </p>
            </div>
          )}
        </div>
