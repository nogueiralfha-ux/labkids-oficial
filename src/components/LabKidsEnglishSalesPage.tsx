    ...
    <div className="min-h-screen bg-[#FDFBF7] text-slate-800 font-sans selection:bg-purple-600 selection:text-white pb-16">
      ...
      <section id="offer" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          ...
          <p className="text-slate-600 text-sm sm:text-base">
            ⚡ One-Time Payment • Lifetime Access • Instant Family Access!
          </p>
        </div>
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="p-8 rounded-3xl bg-white border-2 border-purple-300 shadow-xl flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-black text-slate-900">Lab Kids Channel Only</h3>
              ...
              <div className="pt-2">
                ...
                <div className="text-[11px] text-purple-600 font-bold mt-1">
                  One-time payment • Access for the whole family
                </div>
              </div>
              ...
              <div className="space-y-2.5 pt-4 border-t border-slate-100 text-xs font-semibold text-slate-700">
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
                  <span>90 Interactive Quizzes with XP and Badges</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
      ...
      {/* 12. FOOTER                                                     */}
      {/* ------------------------------------------------------------- */}
      <footer className="bg-slate-950 border-t border-slate-900 py-12 text-center text-xs text-slate-400">
        <div className="max-w-4xl mx-auto px-4 space-y-4">
          <div className="font-black text-white text-lg">Lab Kids - Science & Discoveries</div>
          <div className="space-y-1">
            <p>Support Email: <a href="mailto:alssolucoesltda@gmail.com" className="text-purple-400 hover:underline">alssolucoesltda@gmail.com</a></p>
            <p>WhatsApp: <a href="https://wa.me/5516997327255" target="_blank" rel="noreferrer" className="text-purple-400 hover:underline">+55 (16) 99732-7255</a></p>
          </div>
          <p className="text-[10px] leading-relaxed pt-6 border-t border-slate-800 text-slate-500">
            This site is not a part of the Facebook website or Facebook Inc. Additionally, this site is NOT endorsed by Facebook in any way. FACEBOOK is a trademark of FACEBOOK, Inc. We make every effort to clearly indicate and show all product proof and use real results.
          </p>
          <p className="text-[10px]">&copy; {new Date().getFullYear()} Lab Kids. All rights reserved.</p>
        </div>
      </footer>
